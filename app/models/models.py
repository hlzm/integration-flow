...
class RGSWebhookOutbox(WebhookOutboxBase, Base):
    __tablename__ = "rgs_webhook_outbox"


class OperatorWebhookOutbox(WebhookOutboxBase, Base):
    __tablename__ = "operator_webhook_outbox"
